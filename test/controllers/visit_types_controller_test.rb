...
class VisitTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visit_type" do
    assert_difference('VisitType.count') do
      post visit_types_url, params: { visit_type: { description: @visit_type.description, name: @visit_type.name } }
    end
  ...
  test "should update visit_type" do
    patch visit_type_url(@visit_type), params: { visit_type: { description: @visit_type.description, name: @visit_type.name } }
