...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { comments: @entity.comments, name: @entity.name } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { comments: @entity.comments, name: @entity.name } }
