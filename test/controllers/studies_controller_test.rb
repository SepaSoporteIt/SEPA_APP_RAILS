...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { legislation: @study.legislation, name: @study.name, resolution: @study.resolution, studyID: @study.studyID } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { legislation: @study.legislation, name: @study.name, resolution: @study.resolution, studyID: @study.studyID } }
